...
const MessageDraft = () => {
    ...
    const fetchSubGroup = async () => {
        try {
            ...
            const response = await callAPI.get(
                `/msg/getSubGroupDetail?page=1&limit=200`
            );
    ...
    const handleInputOptionsChange = (e) => {
        ...
        if (
            ...
            selectedValue === "TEXTBOX" ||
            selectedValue === "TEXTAREA" ||
    ...
    const fetchListData = async () => {
        try {
            setLoading(true);
            const response = await callAPI.get(
                `./msg/getMsgDetail?page=${currentPage}&limit=${rowsPerPage}`
            );
    ...
    const handleToggleStatus = async (msgId, isActive) => {
        try {
            const response = await callAPI.get(
                `./msg/toggleMessageStatus?msg_id=${msgId}`
            );

            if (response.status === 200) {
                toast.success(
                    `Message status toggled successfully to ${isActive === 1 ? "Inactive" : "Active"
                    }`
                );
                fetchListData();
            }
    ...
    const data = messageList
        ? messageList?.map((val) => ({
            ...
            isActive: (
                <div className="">
                    <button
                        onClick={() => handleToggleStatus(val?.msg_id, val?.is_active)}
                        type="button"
            ...
            action: (
                <div>
                    {val?.is_active === 1 ? (
                        <Link
                            to={`/send-message`}
                            state={{ id: val?.msg_id, school_id: val?.schools }}
                        >
                            {" "}
                    ...
                    <button
                        onClick={() => handleDelete(val?.msg_id)}
                        type="button"
                        className="btn p-2"
                    >
    ...
    function deleteItem(id) {
        callAPI
            .del(`./msg/delete_MessageGroupData/${id}`)
            .then(async (response) => {
                    ...
                    <div className="main-panel">
                        <div className="content-wrapper">
                            <div className="row">
                                ...
                                <div
                                    className="tab-content border-0 p-0 w-100"
                                    id="myTabContent"
                                >
                                    <div
                                                                                    ...
                                                                                    !msgCategory.includes("INPUT") && (
                                                                                        <>
                                                                                            ...
                                                                                            <Multiselect
                                                                                                        ...
                                                                                                        const newParents =
                                                                                                            event.map((num) => ({
                                                                                                                student_main_id:
                                                                                                                    num.student_main_id,
                                                                                                                mobile_no: parseInt(
                                                                                                                    num.student_family_mobile_number,
                                                                                                                    10
                                                                                                                ),
                                                                                                            }));
                                                                                                        setParentsNumber(
                                                                                                ...
                                                                                                selectedValues={parentsnumber.map(
                                                                                                    (parent) => ({
                                                                                                        student_family_mobile_number:
                                                                                                            parent.mobile_no,
                                                                                                        student_main_id:
                                                                                                            parent.student_main_id,
                                                                                                    })
                                                                                                )}
                                                                                            />
                                                                                        </>
                                                    ...
                                                    <div className="card-body">
                                                        <div className="d-flex justify-content-between align-items-center">
                                                            ...
                                                            <div className="d-flex justify-content-center mb-3">
                                                                <button
                                                                    className=" border-0 bg-transparent px-2 mr-2"
                                                                    onClick={handlePrint}
                                                                >
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header d-flex align-items-center bg-ffe2e5 py-3">
                                <h4 className="modal-title font-weight-bold text-primary">
                                    Warning!
                                </h4>
                                <button
                                    type="button"
